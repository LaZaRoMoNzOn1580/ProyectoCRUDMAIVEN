...
public class SwingApp extends JFrame {
    ...
    private void agregarEmpleado() throws SQLException {
        ...
        JTextField segundoNombre = new JTextField();
        ...
        if (result == JOptionPane.OK_OPTION) {
            ...
            employee.setLast_name(segundoNombre.getText());
            employee.setAddress(Direccion.getText());
            employee.setCity(Ciudad.getText());
        ...
        if (empleadoIdStr != null) {
            try {
                ...
                if (empleado != null) {
                    ...
                    JTextField segundoNombre = new JTextField(empleado.getLast_name());
                    JTextField Direccion = new JTextField(empleado.getAddress());
                    JTextField Ciudad = new JTextField(empleado.getCity());
                    ...
                    if (confirmResult == JOptionPane.OK_OPTION) {
                        ...
                        empleado.setLast_name(segundoNombre.getText());
                        empleado.setAddress(Direccion.getText());
                        empleado.setCity(Ciudad.getText());
